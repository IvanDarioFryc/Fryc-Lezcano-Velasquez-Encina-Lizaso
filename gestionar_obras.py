...
class ControlObra(GestionarObra):
        ...
        for _, fila in df.iterrows():
            try:
                ...
                empresa, _ = Empresa_licitadora.get_or_create(
                    Empresa=fila['licitacion_oferta_empresa'],
                    defaults={'cuit_contratista': fila['cuit_contratista']}
                )
                ...
                Obra.create(
                    ...
                    Plazo=convertir_a_int(fila['plazo_meses']) if fila['plazo_meses'] else 0,
    ...
    def main(cls):
        cls.conectar_db()
        cls.mapear_orm()
        ruta_csv = r"C:\Users\Usuario\Desktop\TP Integrador POO\archivo_prueba.csv"
